...
r = requests.post(url = "https://<URL>/api/2.0/search", data = json.dumps(data, default=str), headers=headers)
...
while True:
	...
	r2 = requests.post(url = "https://<URL>/api/2.0/search", data = json.dumps(data2, default=str), headers=headers)
